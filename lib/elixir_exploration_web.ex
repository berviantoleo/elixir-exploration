defmodule ElixirExplorationWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ElixirExplorationWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/elixir_exploration_web/templates",
        namespace: ElixirExplorationWeb
