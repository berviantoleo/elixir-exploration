defmodule ElixirExplorationWeb.Router do
  use ElixirExplorationWeb, :router

  import ElixirExplorationWeb.UserAuth
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ElixirExplorationWeb.Telemetry
    end
  end
